...
export default function Hero() {
  ...
  // Updated logic: Handles external routes or internal IDs
    ...
    >
      ...
      <div className="relative z-10 max-w-[1400px] mx-auto px-6 md:px-12 lg:px-16 w-full grid lg:grid-cols-[1fr_1.2fr] gap-12 items-center">
        ...
        >
          ...
          <h1 className="text-5xl md:text-6xl xl:text-7xl font-serif text-stone-900 leading-[1.1] mb-8 tracking-tight">
            Elevated <br />
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              <span className="tracking-widest text-[11px] uppercase font-medium">Book Design Visit</span>
          ...
          <div className="mt-16 grid grid-cols-3 gap-8 border-t border-stone-200 pt-8">
            {['500+', '12', 'Free'].map((stat, idx) => (
              <div key={idx}>
                <p className="text-2xl font-serif text-stone-900">{stat}</p>
            ...
            {isLoaded && (
              <div className="absolute top-[40%] left-[60%] group">
                ...
                <div className="absolute left-6 top-1/2 -translate-y-1/2 bg-white p-3 shadow-xl opacity-0 group-hover:opacity-100 transition-all duration-300 translate-x-2 group-hover:translate-x-0 border border-stone-100 min-w-[130px] z-20">
                  <p className="text-[9px] text-stone-400 uppercase tracking-widest mb-1">Modern Collection</p>
                  <p className="text-[10px] font-bold uppercase text-stone-900">Astra Velvet Sofa</p>
                  <p className="text-xs text-stone-500 mt-1 font-serif italic">book</p>
                </div>
              </div>
            )}
          </div>
